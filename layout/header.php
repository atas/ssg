...
<div id="header">
    <div class="info">
        ...
        <div id="h1Wrapper">
            ...
            <h1>
                <a href="/"><?= $config->site_top_h1 ?></a>
            </h1>
            <div class="cursor"></div>
        </div>

        <div class="shortAbout">
            <?= $config->site_top_about_line1 ?>
            <br class="br"/>
            <?= $config->site_top_about_line2 ?>
        </div>
    </div>
...
<div id="bodyWrapper">
    ...
    <div id="content">
        ...
        <div class="socialMediaIcons">
            <?php if (isset($config->linkedin_url) && strlen($config->linkedin_url) > 0) { ?>
                <a href="<?= $config->linkedin_url ?>" target="_blank" rel="nofollow noreferrer" title="on LinkedIn">
